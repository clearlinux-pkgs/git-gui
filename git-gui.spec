...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1615330926
...
cp %{_builddir}/git-2.30.2/COPYING %{buildroot}/usr/share/package-licenses/git-gui/3ee0019d4f4ea0a9d3f50800833f30dc14e2968e
cp %{_builddir}/git-2.30.2/compat/nedmalloc/License.txt %{buildroot}/usr/share/package-licenses/git-gui/3cba29011be2b9d59f6204d6fa0a386b1b2dbd90
cp %{_builddir}/git-2.30.2/contrib/persistent-https/LICENSE %{buildroot}/usr/share/package-licenses/git-gui/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/git-2.30.2/contrib/subtree/COPYING %{buildroot}/usr/share/package-licenses/git-gui/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
cp %{_builddir}/git-2.30.2/sha1dc/LICENSE.txt %{buildroot}/usr/share/package-licenses/git-gui/f0197ae0a546d825bcd59ba21034f36272080a4a
cp %{_builddir}/git-2.30.2/t/diff-lib/COPYING %{buildroot}/usr/share/package-licenses/git-gui/2444921d595953ac768e3fb0c8ed97e62a45dc38
%make_install
